...
def _create_mced_diagnostic_dhf_model(version: int) -> Dict[str, Any]:
    """Generates the complete, interconnected mock dataset for the GenomicsDx Sentry MCED Test DHF."""
    base_date = date(2023, 1, 15)
    demo_current_date = base_date + timedelta(days=450)
    gauss = random.gauss
    team_list = ["Elena Reyes, PhD", "Ben Carter, PhD", "Sofia Chen, PhD", "Marcus Thorne, PhD", "Kenji Tanaka, PhD", "Laura Vance"]

    return {
        "data_version": version,
        "design_plan": {
            "project_name": "GenomicsDx Sentry™ Multi-Cancer Early Detection (MCED) Test",
            "scope": "This program covers the end-to-end development, validation, and commercialization of a blood-based, cell-free DNA (cfDNA) assay for the early detection of multiple cancer types in asymptomatic individuals...",
            "intended_use": "The GenomicsDx Sentry™ Test is a qualitative, prescription-only, blood-based screening test...",
            "team_members": [
                {"role": "Program Lead", "name": "Elena Reyes, PhD", "responsibility": "Overall program oversight, budget, and timeline."},
                {"role": "Clinical Lead", "name": "Ben Carter, PhD", "responsibility": "Clinical trial design, execution, and data analysis."},
        ...
        "clinical_study": {
            ...
            "hf_studies": [
                {"id": "HF-VAL-01", "study_name": "Summative Usability Study - Sample Collection Kit", "user_interface_validated": "Sample Collection Kit & IFU", "user_need_validated": "UN-001: Easy and reliable sample collection", "confirms_risk_control": True, "status": "Completed", "report_link": "/reports/HF-VAL-01.pdf"},
                {"id": "HF-VAL-02", "study_name": "Summative Usability Study - Clinical Report Interpretation", "user_interface_validated": "Clinical Report", "user_need_validated": "UN-001: Clear and unambiguous result reporting", "confirms_risk_control": True, "status": "In Progress", "report_link": ""}
            ]
        },
        "lab_operations": {
...
class SessionStateManager:
    ...
    _CURRENT_DATA_VERSION = 26 # Incremented for fully populated data model
